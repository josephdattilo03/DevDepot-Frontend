        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}>
            <RegisterFrame image={profileImg} title={'Login'} subtitle={"Input your account details. If you don't have an account, click register."}>
                <form style={{ marginTop: '5vh', display: 'flex', flexDirection: 'column', gap: '3vw' }}>
                    <FormInput state={email} setState={setEmail} type='text' image={hollowProfile} placeholder='email' ></FormInput>
                    <FormInput state={password} setState={setPassword} type='password' image={lock} placeholder='password'></FormInput>
                </form>
                ...
                <div style={{ marginTop: '3vw' }}>
                    ...
                    <div onClick={() => onLogin()} className='btn btn-txt'>
                        <p>Login</p>
                    </div>
                </div>
            </RegisterFrame>
